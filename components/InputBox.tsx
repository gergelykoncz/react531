...
import { Text, TextInput, View, StyleSheet, ViewStyle, StyleProp } from 'react-native';
  ...
  return (<>
    <View style={props.style}>
      ...
      <View style={styles.container}>
        ...
        <TextInput style={styles.textBox} keyboardType="numeric" value={value.toString()} onChangeText={change}></TextInput>
